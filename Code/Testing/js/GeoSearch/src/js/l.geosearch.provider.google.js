...
L.GeoSearch.Provider.Google = L.Class.extend({
    ...
    loadMapsApi: function () {
        var key = (typeof(this.options.key) !== 'undefined')? this.options.key : "AIzaSyCweHhUN8N0CnwxHXzAiDM_c_vFYalDj9M";
        var self = this;
        var url = "https://maps.googleapis.com/maps/api/js?key="+key+"&language=en&v=3&callback=onLoadGoogleApiCallback&sensor=false";
