...
function genreBubbles(divID, w, h, inputdata) {
    ...
    bubbles.append("svg")
            ...
            .attr("valueR", function (d) {
                return d.r;
            })
            .attr("valueX", function (d) {
                return d.x;
            })
            .attr("valueY", function (d) {
                return d.y;
            })
            .attr("valueScore", function (d) {
                return d.AverageRating * 10;
            })
            .attr("valueGenre", function (d) {
                return d.Genre;
            })
